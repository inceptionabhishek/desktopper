...
```
cd existing_repo
git remote add origin https://git.turnkey.work/sourabh/proj-teamhub.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.turnkey.work/sourabh/proj-teamhub/-/settings/integrations)
